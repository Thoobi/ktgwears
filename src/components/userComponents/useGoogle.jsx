...
export default function UseGoogle() {
  return (
    <div className="flex flex-col gap-5 border-2 border-gray-600 px-5 py-10 max-lg:py-5 w-[450px] m-auto justify-center items-center max-lg:w-full max-lg:border-[1px] max-lg:border-black">
